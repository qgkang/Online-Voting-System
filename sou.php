<?php include("class/mysql_class.php");?>
    ...
    <p>
        <?php
            ...
            include("header1.php");
        ?>
        <?php if(isset($_POST['content']) && $_POST['content']!= null) { ?>
    </p>
    <table width="1000" height="106" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td height="32" colspan="4" class="STYLE1">
                <blockquote>
        ...
        <tr>
            ...
            <td width="692">
                <div align="center" class="STYLE1">
                    <div align="left">
                        <span class="STYLE3">投票主题
                    </div>
                </div>
            </td>
            <td width="198"><div align="center" class="STYLE1">
                    <span class="STYLE3">结果
                </div>
            </td>
        </tr>
        <?php
        $select = $db->select("ve_vote","where vote_title like '%".$_POST['content']."%'");
        $row = $db->rows($select);
        if($row>=1){
